...
e = [0.9, 0.9, 0.9]    #important values; recycling rates this is r
...
for var in r_range: #iterating through different instances of r
    ...
    iter_r = [var, var, var]
    solved = odeint(system, y0, trange, args = (a, b, m, I, E, iter_r), atol = 1.49012e-10)
    ...
    J = [[-E-a[0]*b[0]*R/((b[0] + N)**2),
     ...
     [a[0]*b[0]*R/((b[0] + N)**2),
      a[0]*N/(b[1] + N)-m[0]-a[1]*b[0]*H/((b[1]+R)**2),
      -a[1]*R/(b[1] + R),
      0],
     [0,
      a[1]*b[1]*H/((b[1] + R)**2),
